        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CecoId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CecoEmpresaId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CabPedidos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CabPedidos_AspNetUsers_SolicitanteId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CabPedidos_Estados_EstadoId",
                        column: x => x.EstadoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CabPedidos_EstadoId",
                table: "CabPedidos",
                column: "EstadoId");

            migrationBuilder.CreateIndex(
                name: "IX_CabPedidos_SolicitanteId",
                table: "CabPedidos",
